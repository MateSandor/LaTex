...
\begin{document}
	...
	\begin{frame}{Beüzemelés}
		\includegraphics[height=5.35cm]{usepackage.png}
	\end{frame}
			...
			\begin{column}{.48\textwidth}
				...
				{\scriptsize{\color{cyan}\textbackslash begin\{{\color{blue}tikzpicture}\}
						...
						{\color{maroon}\quad {\color{orange} \textbackslash begin}\{axis\}[
							...
							{\quad legend entries=\{{\color{mathgreen}\$x\_2=2\$, \\ \quad \$x\_2=4\$}\}}
							\\{\quad ]}\\
	...
	\subsection{Háromdimenziós koordináta-rendszer}
	\begin{frame}{Háromdimenziós koordináta-rendszer}
		\begin{columns}[T] % align columns
			\begin{column}{.48\textwidth}
				{\color{gray}
				...
				\begin{tikzpicture}[scale=0.55]
					\begin{axis}[
						title={\LARGE XYZ koordinátarendszer},
						xlabel={$x$},
						ylabel={$y$},
						zlabel={$z$},
						]
			...
			\begin{column}{.48\textwidth}
				...
				{\color{cyan}\textbackslash begin\{{\color{blue}tikzpicture}\}
					...
					{\color{maroon}\quad {\color{orange} \textbackslash begin}\{axis\}[
						...
						{\color{orange}\textbackslash addplot}3 coordinates \{(0,0,0) (0,0.5,1) (0,1,0)\};
						{\color{orange}\textbackslash addplot}3 coordinates \{(0,1,0) (0.5,1,1) (1,1,0)\};
	...
	\begin{frame}{Exponenciális függvény}
		\begin{columns}[T] % align columns
			\begin{column}{.48\textwidth}
				{\color{gray}
			...
			\begin{column}{.48\textwidth}
				...
				{\color{cyan}\textbackslash begin\{{\color{blue}tikzpicture}\}
					...
					{\color{maroon}\quad {\color{orange} \textbackslash begin}\{axis\}
						...
						{\color{orange}\textbackslash addplot3} [surf,fill=white,domain=\\-2:2] \{exp(-x \^\ 2-y \^\ 2)\};
